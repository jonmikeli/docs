...
See [*Provisioning*](https://github.com/jonmikeli/azureiotdevicesimulator8-dps/docs/Provisioning.md) for details.
...
More details [here](https://github.com/jonmikeli/azureiotdevicesimulator8-dps/docs/Provisioning.md).
...
The simulator has been designed to work in different provisioning use cases:
 1. If the simulator has no connection string, a provisioning process is initiated.
   This process requires a DPS configuration to be set (details [here](https://github.com/jonmikeli/azureiotdevicesimulator8-dps/docs/Provisioning.md)).
...
> NOTE 2
>
> The different authentication types require different parameters. The details about [how to](https://github.com/jonmikeli/azureiotdevicesimulator8-dps/docs/HowTo.md) set the different DPS settings are described [here](https://github.com/jonmikeli/azureiotdevicesimulator8-dps/docs/HowTo.md).
...
> NOTE
>
> The security type implemented for module identities is based on symmetric keys. Depending on the faced use cases, additional possibilities may be added in upcoming versions. Adding X509 module identities will require to add the needed certificates in a secured way (to the cloud and the device).
> Personally, I am wondering why a given device and its module identities could implement different types of security. What requirements may lead to such a scenario?
